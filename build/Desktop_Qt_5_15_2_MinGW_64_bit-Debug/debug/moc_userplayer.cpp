...
QT_MOC_LITERAL(1, 11, 10), // "startClock"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "UserPlayer\0startClock\0"
};
...
void UserPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserPlayer::startClock)) {
                *result = 0;
                return;
            }
        }
