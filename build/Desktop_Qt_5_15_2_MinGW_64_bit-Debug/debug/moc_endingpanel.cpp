...
QT_MOC_LITERAL(1, 12, 12), // "gameContinue"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "EndingPanel\0gameContinue\0"
};
...
void EndingPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EndingPanel::gameContinue)) {
                *result = 0;
                return;
            }
        }
