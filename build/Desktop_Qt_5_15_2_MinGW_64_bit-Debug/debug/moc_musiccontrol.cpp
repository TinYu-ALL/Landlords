...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MusicControl_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MusicControl_t qt_meta_stringdata_MusicControl = {
    {
QT_MOC_LITERAL(0, 0, 12) // "MusicControl"
...
QT_INIT_METAOBJECT const QMetaObject MusicControl::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_MusicControl.data,
    qt_meta_data_MusicControl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *MusicControl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MusicControl.stringdata0))
