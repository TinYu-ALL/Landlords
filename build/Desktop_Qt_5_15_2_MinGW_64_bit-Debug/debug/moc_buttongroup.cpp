...
QT_MOC_LITERAL(3, 19, 8), // "playHand"
QT_MOC_LITERAL(4, 28, 4), // "pass"
QT_MOC_LITERAL(5, 33, 8), // "betPoint"
QT_MOC_LITERAL(6, 42, 3) // "bet"

    },
    "ButtonGroup\0start\0\0playHand\0pass\0"
    "betPoint\0bet"
};
...
void ButtonGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ButtonGroup::start)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ButtonGroup::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ButtonGroup::playHand)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ButtonGroup::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ButtonGroup::pass)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ButtonGroup::betPoint)) {
                *result = 3;
                return;
            }
        }
